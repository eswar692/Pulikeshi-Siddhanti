...
const Problems = () => {
  return (
    <>
      <GlobalStyles />
      <section className="relative overflow-hidden bg-[#161029] px-5 py-24 md:px-10 md:py-32">
        {/* Chart-line watermark instead of a generic dot grid — echoes the
            astrological chart motif used elsewhere on the site */}
        <svg
        ...
        <svg
          className="pointer-events-none absolute -bottom-24 -left-16 h-80 w-80 rotate-12 text-[#d4a24e]/[0.04]"
          viewBox="0 0 200 200"
          fill="none"
          aria-hidden="true"
        >
        ...
        {/* Ambient glow — tuned to indigo/gold instead of flat gold */}
        ...
        <div className="pointer-events-none absolute bottom-0 left-1/2 h-[200px] w-[500px] -translate-x-1/2 rounded-full bg-[radial-gradient(ellipse,rgba(90,70,150,0.15),transparent_70%)]" />
        ...
        <div className="relative mx-auto max-w-[1400px]">
          ...
          >
            ...
            <motion.div className="mb-4 flex items-center gap-3">
              <div className="h-px w-8 bg-[linear-gradient(90deg,#d4a24e,transparent)]" />
              <span
                className="text-[0.6rem] uppercase tracking-[0.28em] text-[#d4a24e]/70"
            ...
            {/* Heading row */}
            <motion.div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
              <div>
                <h2
                  className="font-bold leading-none text-[#fdf6ec]"
                  style={{
                    fontFamily:
                ...
                <h2
                  className="mt-1 font-bold leading-none text-[#d4a24e]"
                  style={{
                    fontFamily:
                      "'Cinzel Decorative', 'Playfair Display', serif",
                    fontSize: "clamp(1.8rem, 4vw, 3.2rem)",
              ...
              <div className="flex items-center gap-4">
                <div className="h-px flex-1 bg-[linear-gradient(90deg,transparent,rgba(212,162,78,0.35))] md:w-32" />
                <span
                  className="font-light text-[#fdf6ec]/15"
            ...
            {/* Subtitle */}
            <motion.p
              className="mt-5 max-w-lg leading-relaxed text-[#fdf6ec]/40"
              style={{
            ...
            >
              Rooted in traditional Kerala wisdom, each consultation is
              tailored to your unique situation — bringing light to life's
